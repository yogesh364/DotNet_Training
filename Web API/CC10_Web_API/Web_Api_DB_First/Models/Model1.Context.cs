...
namespace Web_Api_DB_First.Models
{
    ...
    public partial class NorthWindEntities : DbContext
    {
        ...
        [DbFunction("NorthWindEntities", "fn_get_Country")]
        public virtual IQueryable<fn_get_Country_Result> fn_get_Country(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_get_Country_Result>("[NorthWindEntities].[fn_get_Country](@country)", countryParameter);
        }
