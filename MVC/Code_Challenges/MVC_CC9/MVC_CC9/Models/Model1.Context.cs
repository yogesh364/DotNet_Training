...
namespace MVC_CC9.Models
{
    ...
    public partial class NorthWindEntities1 : DbContext
    {
        ...
        [DbFunction("NorthWindEntities1", "fn_get_Country")]
        public virtual IQueryable<fn_get_Country_Result> fn_get_Country(string country)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_get_Country_Result>("[NorthWindEntities1].[fn_get_Country](@country)", countryParameter);
        }
